...
import com.example.dedztbh.deshine.app.data.WeatherProvider;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String symbol = sharedPrefs.getString(mContext.getString(R.string.pref_unit_key), mContext.getString(R.string.pref_unit_default)).equals("m")?"℃":"℉";
        String highLowStr = roundedHigh +symbol+  "/" + roundedLow+symbol;
        return highLowStr;
    }
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        final String OWM_DESCRIPTION = /*"main"*/"description";
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(LANG_PARAM, "zh_cn")
                    .appendQueryParameter(APPID_PARAM, "13a744fc585e873c0366b958c2fe1f84")
                    .build();
